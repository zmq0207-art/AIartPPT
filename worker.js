...
- agenda（目录）：仅在文章有3个以上明确章节时使用，出现一次，列出所有章节名称
- section（章节过渡页）：每个大章节开始前的分隔页，标题即章节名，subtitle是一句话概括本章内容；必须与agenda目录中的条目一一对应，不需要 points 字段
- content（内容页）：每页聚焦一个明确议题，不要把不相关内容堆在一页
- end（结尾）：行动号召、总结金句或致谢，简短有力

【结构规则——必须遵守】
整体结构必须是：cover → agenda → section(章节一) → content... → section(章节二) → content... → ... → end
- agenda 列出几个章节，就必须有几个对应的 section 页，名称完全一致
- 每个 section 后面紧跟该章节的若干 content 页
...
- 封面、目录、章节页、结尾不计入上述内容页数量
- 每页要点数：${maxPoints}个以内
- 要点文字中禁止使用英文双引号（"），用中文引号（「」）代替

【layout字段——每张content页必须填写】
根据该页内容特征，选择最合适的版式：
- "content_stats"       → 要点包含具体数字/百分比，且要点数≤3
- "content_timeline"    → 步骤、流程、发展阶段、时间顺序
- "content_cards"       → 3-4个并列概念、特性、优势（每点独立）
- "content_split"       → 对比、两种视角，或要点数恰好为2
- "content_feature"     → 单一议题深度展开，要点5个以上
- "content_list_accent" → 叙述性要点列表，4-6个
不确定时默认用 "content_cards"。

【JSON格式示例（含layout字段）】
[
  {"type":"cover","title":"简洁有力的主标题","subtitle":"副标题/作者/场合/日期"},
  {"type":"agenda","title":"本次分享结构","points":["一、为什么现在必须做","二、主要挑战在哪里","三、三步落地路径"]},
  {"type":"section","title":"一、为什么现在必须做","subtitle":"外部压力与内部瓶颈同时爆发，窗口期正在关闭"},
  {"type":"content","layout":"content_stats","title":"核心挑战数据一览","subtitle":"三重压力叠加，传统模式已无法支撑业务增长","points":["成本压力：原材料涨价23%，人工成本5年翻倍，毛利率从35%压缩至18%","效率瓶颈：订单处理依赖人工录入，响应时间4.2小时，竞对已实现分钟级","客户流失：2023年净流失率8.3%，62%投诉与交付不稳定相关"]},
  {"type":"section","title":"二、主要挑战在哪里","subtitle":"三重结构性障碍制约增长，需逐一击破"},
  {"type":"content","layout":"content_cards","title":"组织能力是最大瓶颈","subtitle":"技术已不是门槛，执行落地才是真正的竞争壁垒","points":["决策链条过长：从需求提出到上线平均耗时47天，竞对已压缩至9天","人才缺口严峻：关键岗位空缺率38%，外部招聘周期平均超过5个月","激励错位：现有KPI体系仍以规模为导向，与转型目标存在结构性冲突"]},
...
【幻灯片类型说明】
- cover（封面）：主标题是核心结论或最有冲击力的观点，不是主题的简单复述
- agenda（目录）：列出所有章节名称，章节名要是"议题"而非"标签"，如"为什么现在必须转型"而非"背景介绍"
- section（章节过渡页）：每个大章节开始前的分隔页，标题即章节名，subtitle是一句话概括本章内容；必须与agenda目录中的条目一一对应
- content（内容页）：每页有明确的subtitle论点，要点是支撑论点的论据
- end（结尾）：行动号召或核心金句，让观众带着明确指令离场

【结构规则——必须遵守】
整体结构必须是：cover → agenda → section(章节一) → content... → section(章节二) → content... → ... → end
- agenda 列出几个章节，就必须有几个对应的 section 页，名称完全一致
- 每个 section 后面紧跟该章节的若干 content 页
- section 不需要 points 字段
...
[
  ...
  {"type":"agenda","title":"本次分享结构","points":["一、为什么现在必须做","二、主要挑战在哪里","三、三步落地路径"]},
  {"type":"section","title":"一、为什么现在必须做","subtitle":"外部压力与内部瓶颈同时爆发，窗口期正在关闭"},
  {"type":"content","layout":"content_stats","title":"市场规模已到临界点","subtitle":"三个核心数据说明行业正在加速分化","points":["2024年市场规模达480亿，同比增速67%，首次超过移动互联网","TOP5玩家市场份额73%，新进入者窗口期不超过18个月","用户复购率从31%升至58%，产品从尝鲜转向依赖"]},
  {"type":"section","title":"二、主要挑战在哪里","subtitle":"三重结构性障碍制约增长，需逐一击破"},
  {"type":"content","layout":"content_cards","title":"组织能力是最大瓶颈","subtitle":"技术已不是门槛，执行落地才是真正的竞争壁垒","points":["决策链条过长：从需求提出到上线平均耗时47天，竞对已压缩至9天","人才缺口严峻：关键岗位空缺率38%，外部招聘周期平均超过5个月","激励错位：现有KPI体系仍以规模为导向，与转型目标存在结构性冲突"]},
  {"type":"section","title":"三、三步落地路径","subtitle":"分阶段推进，以快速见效建立信心，以系统建设巩固优势"},
  {"type":"content","layout":"content_timeline","title":"三步落地路径","subtitle":"用90天MVP验证，再系统复制扩展","points":["第一步：选1-2个试点单元，90天完成MVP，设定效率提升≥30%等可量化目标","第二步：复制成功经验，扩展至全业务线，建立标准化流程与考核机制","第三步：构建数据中台，实现跨业务线协同，持续迭代优化"]},
